use crate::{common::{errors::HydraIOError, timing::ModuloCounter}, deserialize, emulator::gameboy::{GbMode, memory::{MemoryMap, MemoryMapped}, ppu::{PpuMode, state::PpuState}}, serialize};
