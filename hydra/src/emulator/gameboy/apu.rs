...
use crate::{audio::Audio, common::audio, emulator::gameboy::{GbModel, apu::{channel::{Noise, Pulse, PulseType, Wave}, state::ApuState}, memory::MemoryMap, timer::MasterTimer}};
...
impl Apu {
    ...
    const SAMPLE_RATE: u32 = Self::PPU_DOTS_PER_FRAME * 30;
