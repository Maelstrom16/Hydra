...
const fn init_opcode_table() -> [OpHandler; 0x100] {
    ...
    opcode_table[0x84] = |cpu| {
        // ADD H
        cpu.add(RegisterOperand8(cpu::Register8::H));
    };
    opcode_table[0x85] = |cpu| {
        // ADD L
    ...
    opcode_table[0xA8] = |cpu| {
        // XOR B
        cpu.xor(RegisterOperand8(cpu::Register8::B));
    };
    opcode_table[0xA9] = |cpu| {
        // XOR C
    ...
    opcode_table[0xC8] = |cpu| {
        // RET Z
        cpu.ret(CondOperand::Z);
    };
    opcode_table[0xC9] = |cpu| {
        // RET
...
const fn init_cb_table() -> [OpHandler; 0x100] {
    ...
    opcode_table[0x08] = |cpu| {
        // RRC B
        cpu.rrc(RegisterOperand8(cpu::Register8::B));
    };
    opcode_table[0x09] = |cpu| {
        // RRC C
    ...
    opcode_table[0x29] = |cpu| {
        // SRA C
        cpu.sra(RegisterOperand8(cpu::Register8::C));
    };
    opcode_table[0x2A] = |cpu| {
        // SRA D
    ...
    opcode_table[0x39] = |cpu| {
        // SRL C
        cpu.srl(RegisterOperand8(cpu::Register8::C));
    };
    opcode_table[0x3A] = |cpu| {
        // SRL D
    ...
    opcode_table[0xFC] = |cpu| {
        // SET 7, H
        cpu.set(7, RegisterOperand8(cpu::Register8::H))
    };
    opcode_table[0xFD] = |cpu| {
        // SET 7, L
