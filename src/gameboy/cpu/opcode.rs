...
impl<O: IntOperand<u16>> IntOperand<u16> for IndirectOperand8<O> {
    ...
    async fn get(&self, cpu: &mut CPU, memory: &mut Memory, co: Co<'_, ()>) -> u16 {
        let address = gen_all!(co, |co_inner| self.0.get(cpu, memory, co_inner));
        u16::from_le_bytes([gen_all!(&co, |co_inner| cpu.read_u8(address, memory, co_inner)), gen_all!(&co, |co_inner| cpu.read_u8(address + 1, memory, co_inner))])
    }
    #[inline(always)]
...
impl CPU {
    pub async fn opcode_gen(&mut self, memory: &mut Memory, co: Co<'_, ()>) {
        match self.ir {
            ...
            0x02 => { // LD (BC), A
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::BC)), RegisterOperand8(cpu::Register8::A)));
            },
            0x03 => { // INC BC
            ...
            0x0A => { // LD A, (BC)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::A), IndirectOperand8(RegisterOperand16(cpu::Register16::BC))));
            },
            0x0B => { // DEC BC
            ...
            0x12 => { // LD (DE), A
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::DE)), RegisterOperand8(cpu::Register8::A)));
            },
            0x13 => { // INC DE
            ...
            0x1A => { // LD A, (DE)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::A), IndirectOperand8(RegisterOperand16(cpu::Register16::DE))));
            },
            0x1B => { // DEC DE
            ...
            0x22 => { // LD (HL+), A
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IncIndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::A)));
            },
            0x23 => { // INC HL
            ...
            0x2A => { // LD A, (HL+)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::A), IncIndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x2B => { // DEC HL
            ...
            0x32 => { // LD (HL-), A
                gen_all!(co, |co_inner| self.ld(memory, co_inner, DecIndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::A)));
            },
            0x33 => { // INC SP
            ...
            0x3A => { // LD A, (HL-)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::A), DecIndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x3B => { // DEC SP
            ...
            0x46 => { // LD B, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::B), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x47 => { // LD B, A
            ...
            0x4E => { // LD C, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::C), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x4F => { // LD C, A
            ...
            0x56 => { // LD D, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::D), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x57 => { // LD D, A
            ...
            0x5E => { // LD E, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::E), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x5F => { // LD E, A
            ...
            0x66 => { // LD H, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::H), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x67 => { // LD H, A
            ...
            0x6E => { // LD L, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::L), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x6F => { // LD L, A
            ...
            0x70 => { // LD (HL), B
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::B)));
            },
            0x71 => { // LD (HL), C
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::C)));
            },
            0x72 => { // LD (HL), D
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::D)));
            },
            0x73 => { // LD (HL), E
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::E)));
            },
            0x74 => { // LD (HL), H
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::H)));
            },
            0x75 => { // LD (HL), L
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::L)));
            },
            0x76 => { // HALT
                gen_all!(co, |co_inner| self.halt(memory, co_inner));
            },
            0x77 => { // LD (HL), A
                gen_all!(co, |co_inner| self.ld(memory, co_inner, IndirectOperand8(RegisterOperand16(cpu::Register16::HL)), RegisterOperand8(cpu::Register8::A)));
            },
            0x78 => { // LD A, B
            ...
            0x7E => { // LD A, (HL)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::A), IndirectOperand8(RegisterOperand16(cpu::Register16::HL))));
            },
            0x7F => { // LD A, A
            ...
            0xE2 => { // LDH (C), A
                gen_all!(co, |co_inner| self.ld(memory, co_inner, HramIndirectOperand(RegisterOperand8(cpu::Register8::C)), RegisterOperand8(cpu::Register8::A)));
            },
            // 0xE3 (invalid)
            // 0xE4 (invalid)
            0xE5 => { // PUSH HL
            ...
            0xF2 => { // LDH A, (C)
                gen_all!(co, |co_inner| self.ld(memory, co_inner, RegisterOperand8(cpu::Register8::A), HramIndirectOperand(RegisterOperand8(cpu::Register8::C))));
            },
            0xF3 => { // DI
